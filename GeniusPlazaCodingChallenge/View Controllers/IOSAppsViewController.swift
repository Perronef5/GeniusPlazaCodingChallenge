...
class IOSAppsViewController: UIViewController {
    ...
    func prepareLayout() {
        ...
        // Network Request
        ApiFunctions.getIOSAppsData(urlRequest: Constants.IOSAPPS_URL) { (response, mediaObjects ) in
    ...
    override func viewDidLayoutSubviews() {
        ...
        if headerView.frame.size.height != size.height {
            ...
            headerView.mediaTypeLabel.text = "iOS Apps"
...
extension IOSAppsViewController : UITableViewDelegate, UITableViewDataSource{
